#############################################################
##     Get log2FC siNIPBL vs WT at cohesinCTCF noCTCF positions
##
##  Generate .tsv file with coordinates, chipped protein and 
##  log2FC scores 
#############################################################
...
# Read scores from bw using pyBigWig and .bed with coordenates
...
# Create data.frame to save .bw scores
...
# Extract sample information from filename. Always the same format for filename
...
# Loop to process .bw and .beds
# Only get scores if .bw and .bed come from the same sample (Protein and siRNA)
...
# Check: Missing Data as zero (np.ma.masked_array)
